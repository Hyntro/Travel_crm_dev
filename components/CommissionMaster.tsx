...
import { initialCommissions } from './mockData';

interface CommissionMasterProps {
  onBack: () => void;
}

const CommissionMaster: React.FC<CommissionMasterProps> = ({ onBack }) => {
  ...
  const filteredCommissions = commissions.filter(c => {
    return (commissionStatusFilter === 'All' || c.status === commissionStatusFilter) &&
           c.name.toLowerCase().includes(commissionSearch.toLowerCase());
  });
